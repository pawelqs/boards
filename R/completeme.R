...
#'   pins <- tibble::tribble(
#'     ~"board", ~"pin",
#'     "PhD_analyses", "sample_features",
#'     "PhD_analyses", "patient_features",
#'     "BLCA_2maps", "sample_features",
#'   )
#'
#'   if (current_function(env) %in% "read_pin") {
#'     pin_names <- paste0(pins$board, "::", pins$pin)
#'     return(paste0('"', pin_names, '"'))
#'   }
...
#'   # }
#'   # projects <- c("PhD_analyses", "sdfdfd")
#'
#'   # if (current_function(env) == "read_pin") {
#'     # return(paste0('"', projects, '"'))
#'     # return(projects)
#'   # }
#' }
#'
...
#'   register_completion(boards = boards_completer)
#' }
